...
# option 1 model
# clf = AdaBoostClassifier(base_estimator=DecisionTreeClassifier(min_samples_leaf=5), n_estimators=30, random_state=0).fit(X_train, Y_train)
# option 2 model
# clf = AdaBoostClassifier(base_estimator=DecisionTreeClassifier(max_depth=None), n_estimators=30, random_state=0).fit(X_train, Y_train)
# option 3 model
clf = AdaBoostClassifier(base_estimator=DecisionTreeClassifier(max_depth=1), n_estimators=30, random_state=0).fit(X_train, Y_train)
